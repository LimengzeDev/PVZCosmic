...
- **High expandability**: The game will have high expandability and openness, supporting in-game import extensions to customize plants, zombies, levels, and even modes, while supporting direct calls to online extensions to minimize storage usage.
## How to run
